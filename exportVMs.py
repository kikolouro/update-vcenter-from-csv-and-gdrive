...
def main():
    ...
    sendEmailwithAttachment('francisco.louro@infosistema.com', {'email': config('SENDER_EMAIL'), 'password': config('SENDER_PASSWORD')}, f'VMList-{date}.csv'.format(date=date), warnings)
